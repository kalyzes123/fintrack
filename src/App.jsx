            ...
            <>
              <div className="flex items-start justify-between mb-8">
                ...
                <div className="hidden sm:flex items-center">
                  <input
                    ...
                    className="px-4 py-2 border border-[var(--color-border)] rounded-lg text-sm text-[var(--color-text-primary)] bg-[var(--color-card)] hover:bg-gray-50 cursor-pointer"
                  />
                </div>
              </div>
              ...
              <div className="flex sm:hidden mb-4">
                <input
                  ...
                  value={dateRange}
                  onChange={(e) => setDateRange(e.target.value)}
                  className="px-3 py-2 border border-[var(--color-border)] rounded-lg text-sm text-[var(--color-text-primary)] bg-[var(--color-card)]"
                />
              </div>
